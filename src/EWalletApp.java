...
public class EWalletApp {
	...
	// Note for Ethan: When you finish the login GUI, please set the current user to this variable
	// because I need it for implementing some methods in ExpenseCalculator :)
